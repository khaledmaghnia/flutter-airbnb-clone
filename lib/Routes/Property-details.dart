            ...
            Padding(
              ...
              child: Row(
                children: <Widget>[
                  Container(
                      margin:EdgeInsets.only(right: 5),
                      child: Icon(Icons.star,color: Colors.red,size: 25,)),
                  Container(
                    margin:EdgeInsets.only(right: 5),
                    child: Align(
                      alignment: Alignment.topLeft,
        ...
        Padding(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              Icon(Icons.wifi,color: commodite.wifi?Colors.red:Colors.grey,)
            ],
          ),
        ),
        Padding(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              Icon(Icons.local_laundry_service,color: commodite.serviceDeChambre?Colors.red:Colors.grey,)
            ],
          ),
        ),
        Padding(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              Icon(Icons.pool,color: commodite.piscine?Colors.red:Colors.grey,)
            ],
          ),
        ),
        Padding(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              Icon(Icons.fitness_center,color: commodite.gym?Colors.red:Colors.grey,)
            ],
          ),
        ),
        Padding(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              Icon(Icons.room_service,color: commodite.repasInclus?Colors.red:Colors.grey,)
            ],
          ),
        ),
        Padding(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              Icon(Icons.child_care,color: commodite.enfantAutorise?Colors.red:Colors.grey,)
            ],
          ),
        ),
        Padding(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              Icon(Icons.local_parking,color: commodite.Parking?Colors.red:Colors.grey,)
            ],
          ),
        ),
        Padding(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              Icon(Icons.widgets,color: commodite.equipe?Colors.red:Colors.grey,)
            ],
          ),
        ),
      ],
    ...
    return Container(
        ...
        child:GestureDetector(
          child:Container(
            ...
            child: Icon(!_liked?Icons.favorite_border:Icons.favorite,color:!_liked? Colors.black:Colors.red,size: 20,),
          ),
          onTap: (){
            setState(() {
              _liked=!_liked;
